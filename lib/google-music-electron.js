...
gme.onTrayClick = (config.get('hideViaTray') || config.get('minimizeToTray')) ?
  gme.toggleVisibility : gme.toggleMinimize;
gme.onRaise = (config.get('hideViaTray') || config.get('minimizeToTray')) ?
...
app.on('ready', function handleReady () {
  ...
  var windowOpts = {
    ...
    'skip-taskbar': config.get('skipTaskbar'),
