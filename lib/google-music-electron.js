...
var cliConfigKeys = ['skip-taskbar', 'minimize-to-tray', 'hide-via-tray'];
...
// TODO: This currently isn't utilizing `cliConfigKeys` since we have `dash-case` in settings vs `camelCase` in commander
var config = new Config(_.pick(program, cliConfigKeys), cliInfo);
