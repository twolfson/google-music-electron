...
var gme = {
  ...
  reloadWindow: function () {
    logger.debug('Reloading focused browser window and clear its history');
    // DEV: We clear window history as history changes are no longer push/pop states so navigation breaks
