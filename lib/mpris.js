...
exports.init = function (gme) {
  ...
  var songInfo = {};
  ipc.on('change:song', function handleSongChange (evt, _songInfo) {
  ...
  var playbackStrings = {};
  playbackStrings[GMusic.Playback.PLAYING] = 'Playing';
  playbackStrings[GMusic.Playback.PAUSED] = 'Paused';
  playbackStrings[GMusic.Playback.STOPPED] = 'Stopped';
